    ...
    <form className="cm-seo-form" onSubmit={handleSubmit}>
      <div className="cm-seo-form-grid">
        <div className="cm-seo-form-group">
          ...
          <input type="text" name="ruta_url" value={formData.ruta_url} onChange={handleChange} required />
        </div>
        ...
        <div className="cm-seo-form-group">
          ...
          <input type="number" name="entidad_id" value={formData.entidad_id || ''} onChange={handleChange} />
        </div>

        <div className="cm-seo-form-group">
          <label>Producto ID</label>
          <input type="number" name="producto_id" value={formData.producto_id || ''} onChange={handleChange} />
        </div>
        <div className="cm-seo-form-group">
          <label>Blog ID</label>
          <input type="number" name="blog_id" value={formData.blog_id || ''} onChange={handleChange} />
        </div>
        <div className="cm-seo-form-group">
          <label>Categoría ID</label>
          <input type="number" name="categoria_id" value={formData.categoria_id || ''} onChange={handleChange} />
        </div>
        <div className="cm-seo-form-group">
          <label>Página Estática ID</label>
          <input type="number" name="pagina_estatica_id" value={formData.pagina_estatica_id || ''} onChange={handleChange} />
        </div>

        <div className="cm-seo-form-group full-width">
          <label>Meta Título</label>
          <input type="text" name="meta_titulo" value={formData.meta_titulo || ''} onChange={handleChange} maxLength="70" />
        </div>

        <div className="cm-seo-form-group full-width">
          <label>Meta Descripción</label>
          <textarea name="meta_descripcion" value={formData.meta_descripcion || ''} onChange={handleChange} rows="2" maxLength="160" />
        </div>

        <div className="cm-seo-form-group full-width">
          <label>Frase Clave</label>
          <input type="text" name="frase_clave" value={formData.frase_clave || ''} onChange={handleChange} />
        </div>
        ...
        <div className="cm-seo-form-group full-width">
          ...
          <input type="text" name="titulo_migas_pan" value={formData.titulo_migas_pan || ''} onChange={handleChange} />
        </div>

        <div className="cm-seo-form-group full-width">
          <label>URL Canónica</label>
          <input type="text" name="url_canonica" value={formData.url_canonica || ''} onChange={handleChange} />
        </div>

        <div className="cm-seo-form-group full-width">
          <label>OG Título</label>
          <input type="text" name="og_titulo" value={formData.og_titulo || ''} onChange={handleChange} />
        </div>

        <div className="cm-seo-form-group full-width">
          <label>OG Descripción</label>
          <textarea name="og_descripcion" value={formData.og_descripcion || ''} onChange={handleChange} rows="2" />
        </div>
        ...
        <div className="cm-seo-form-group full-width">
          ...
          <textarea name="schema_json" value={formData.schema_json || ''} onChange={handleChange} rows="6" placeholder='{"@context":"https://schema.org", ...}' />
        </div>
      </div>
